...
gpu_profile_fn = f"Host_{socket.gethostname()}_gpu_mem_prof-{datetime.datetime.now():%d-%b-%y-%H-%M-%S}.prof.txt"
                ...
                with open(gpu_profile_fn, 'a+') as f:
                    ...
                    if print_tensor_sizes is True:
                        ...
                        for t, s, loc in new_tensor_sizes - last_tensor_sizes:
                            print(f'+ {loc:<50} {str(s):<20} {str(t):<10}\n')
